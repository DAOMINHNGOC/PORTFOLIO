...
const BlogPage = () => {
  ...
  <div class=" ">
      ...
      <!-- project name 1 -->
      <section class="w-[1100px] mx-auto mb-[80px] mt-20">
          <div class="rows">
             
                  ${blogs.map((blog) => {
                    return `
                     <div class="col grid grid-cols-[300px,auto] flex items-center bg-slate-50 shadow   h-[300px]">
                      <div class="">
                          <a href="">
                              <img src="${blog.album}"
                      ...
                      <div class="p-10">
                          ...
                          <div class=" my-6">
                              <a class="text-[30px] font-bold" href="">${blog.title}</a>
                          </div>
